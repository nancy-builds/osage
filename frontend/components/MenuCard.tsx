      ...
      <div className="p-3">
        <div className="flex items-start justify-between gap-2 mb-1">
          <div className="flex-1">
            ...
            {item.nameJapanese && <p className="text-xs text-muted-foreground">{item.nameJapanese}</p>}
          </div>
        </div>
        ...
        <div className="flex gap-1 mb-2 flex-wrap">
          {item.vegetarian && (
            <span className="text-xs bg-green-100 text-green-700 px-2 py-0.5 rounded">Vegetarian</span>
          )}
          {item.spicy && <span className="text-xs bg-red-100 text-red-700 px-2 py-0.5 rounded">Spicy</span>}
        </div>
